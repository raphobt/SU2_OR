...
!      REAL(8), DIMENSION (2,1)  :: F_out
     ...
     &            helmho_v,helmho_l,deriv,dummy1,dummy2,x_out,a_out,enth,h
!           
      IF     (MODE .EQ. 1) THEN
...
!
	...
	! Calculation of temperature and specific volume for imposed enthalpy h
	! and entropy, s.
	! 
	! For this function:
	!         in_1     = h
	...
	!print*, 'T',T,'v',v,'p',p,'e',e
		  F(1,1) = (in_1 - h)*1d-3         ! J/kg
		  F(2,1) = (in_2 - s)*1d-3         ! J/kg/K
	!print*, F(1,1),F(2,1)
	!print*, in_1,in_2, p,e
!
!
